...
/*  delay(500);
  Serial.println(analogRead(SWITCH_02));
  if (analogRead(SWITCH_02) < 512) iCurrentMode = 1;
  if (iCurrentMode == 1){    pinMode(LED_RED, OUTPUT);
...
//currentMillis_1 = currentMillis_2 - currentMillis_1;
//Serial.begin(115200); Serial.print("Time: "); Serial.println(currentMillis_1); Serial.println(); delay(50); Serial.end();
